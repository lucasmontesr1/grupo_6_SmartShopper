...
module.exports = (req, res, next) => {
   if (req.session.usuario) {
      cartItem.findAndCountAll({  //Este es un metodo de sequelize que me permite contar la cantidad de regsitros que hay con respecto a cierta condición indicada
         where: {
